                ...
                >
                  ...
                  <div className="flex items-start gap-3 px-5 py-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      {user.role === "student" && user.currentGradeLevel && (
                        <p className="text-xs font-medium text-green-600">
                          Grade {user.currentGradeLevel}
                        </p>
                      )}
                    </div>
                  </div>
          ...
          <div className="w-full max-w-lg overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl">
            ...
            <div className="px-6 py-6">
              <dl className="divide-y divide-gray-200">
                ...
                {/* Added Grade Level in View Modal */}
                {viewModal.user.role === "student" && viewModal.user.currentGradeLevel && (
                  <div className="grid grid-cols-3 gap-4 py-3">
                    <dt className="text-sm font-medium text-gray-500">Grade Level</dt>
                    <dd className="col-span-2 text-sm text-gray-900">Grade {viewModal.user.currentGradeLevel}</dd>
                  </div>
                )}
